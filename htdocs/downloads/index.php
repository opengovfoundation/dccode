...
$body = '
	<h2>Laws as JSON</h2>
	<p><a href="/downloads/current/code.json.zip">code.json.zip</a><br />
	...
	<p><a href="/downloads/current/code.txt.zip">code.txt.zip</a><br />
	...
	<p><a href="/downloads/current/dictionary.json.zip">dictionary.json.zip</a><br />
